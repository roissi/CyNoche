      ...
      <VStack spacing={3} w="100%" alignItems="center">
        ...
        <Flex direction="row" justify="center" align="flex-start" w="100%">
          <Box>
            ...
            <Box display="flex" flexDirection="column" alignItems="center">
              <Stack mt={10} mb={10} spacing={4} direction='row' align='center'>
          ...
          <Box ml={5}>
            <AddModal /> {/* Ajout de votre composant MyModal ici */}
          </Box>
        </Flex>
        <Box display="flex" flexDirection="column" alignItems="center" w="100%">
          <Heading as="h2" mb={3}>Come on, search...</Heading>
          <form onSubmit={e => {
            e.preventDefault();
            setPageBeforeSearch(currentPage); // Sauvegardez la page courante avant la recherche
            searchMovies();
            setSearchPerformed(true);
          }}>
            ...
            <Stack direction='row' justify='center' spacing={4} mt={4}>
              ...
              {searchPerformed && (
                <Button colorScheme='teal' size='md' onClick={() => {
                  ...
                  setCurrentPage(pageBeforeSearch); // Restaurez la page avant la recherche
